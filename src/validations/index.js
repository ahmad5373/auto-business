...
const createCarValidation = [
  ...
  body('basicData.mileageUnit').not().isEmpty().withMessage("Valid mileage Unit is required"),
  ...
  body('basicData.powerUnit').not().isEmpty().withMessage("power Unit is required"),
  ...
  body('basicData.price').not().isEmpty().withMessage("price is required"),
